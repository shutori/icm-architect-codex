...
This is an unofficial Codex compatibility adaptation of [RinDig/icm-architect](https://github.com/RinDig/icm-architect). The original ICM method and source material are retained under the upstream MIT license; this edition changes the integration layer to Codex and uses `AGENTS.md` as the sole generated routing entry point.
